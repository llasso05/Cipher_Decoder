...
# the string to be decrypted (type orpaste between triple-qoutes)
...
# key with apace between numbers; negative read  UP column

key = '''-1 2 -3 4'''

# END OF USER INPOT - DO NOT EDIT BELOW THIS LINE 
# =============================================================================
...
def main():
    ...
    # split elements in words, not letters
